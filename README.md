...
=============
"Number Line: Integers" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/number-line-integers/latest/number-line-integers_en.html" target="_blank">Click here to
run "Number Line: Integers".</a>
...
(5) Open in the browser: `http://localhost/number-line-integers/number-line-integers_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/number-line-integers/build/adapted-from-phet/number-line-integers_en_adapted-from-phet.html` (You will
