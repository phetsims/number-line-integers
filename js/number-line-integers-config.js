 ...
 * please modify number-line-integers/package.json to control dependencies.
 *
 * RequireJS configuration file for the number-line-integers sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'number-line-integers-main' ],
